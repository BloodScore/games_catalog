function openNav() {
    ...
    document.getElementById("open_btn").style.backgroundColor = "white";
//    document.getElementById("mySidepanel").style.color = "white";
}

function closeNav() {
//    document.getElementById("mySidepanel").style.color = "red";
    document.getElementById("mySidepanel").style.width = "0";
    document.getElementById("open_btn").style.backgroundColor = "red";
}
